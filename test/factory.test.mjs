...
const pkg=(name='safe-cap',extra={})=>({schema:'acr/candidate-package/v0.1',name,version:'0.1.0',description:'Read only reference content.',category:'documentation',tags:['documentation'],permissions:{network:false,filesystem:false,database:false,shell:false},files:[{path:'README.md',content:'# Reference\n\nA harmless command, script, git, and npm are just words here.'},{path:'evals/cases.json',content:JSON.stringify([{id:'basic',input:{value:1},expected:{value:1}}])}],...extra});
